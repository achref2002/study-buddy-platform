...
async function PUT(req) {
    try {
        ...
        const { name, grade, subjects } = await req.json();
        const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateStudent"])(session.user.id, {
            name,
            grade,
            subjects
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f876356._.js.map